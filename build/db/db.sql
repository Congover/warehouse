...
CREATE TABLE `tPACKING` (
  ...
  `CREATE_DATE` date NOT NULL,
  `PACKED_PRODUCT_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`PAKING_ID`),
  KEY `IDX_FK_PRODUCT_TO_P` (`PRODUCT_ID`),
  KEY `IDX_FK_PACKED_PRODUCT` (`PACKED_PRODUCT_ID`),
  CONSTRAINT `FK_PRODUCT_TO_P` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `tproduct` (`PRODUCT_ID`),
  CONSTRAINT `FK_PACKED_PRODUCT` FOREIGN KEY (`PACKED_PRODUCT_ID`) REFERENCES `tproduct` (`PRODUCT_ID`)
);
